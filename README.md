...
You can download the last release here: https://github.com/scaleway/scaleway-cli/releases/download/v2.2.1/scw-2.2.1-windows-x86_64.exe<br/>
...
wget "https://github.com/scaleway/scaleway-cli/releases/download/v2.2.1/scw-v2.2.1-${ARCH}.deb" -O /tmp/scw.deb
```
...
```sh
docker run -i --rm scaleway/cli:v2.2.1
```

...
curl -o /usr/local/bin/scw -L "https://github.com/scaleway/scaleway-cli/releases/download/v2.2.2/scw-2.2.2-darwin-x86_64"
...
```bash
# Download the release from github
sudo curl -o /usr/local/bin/scw -L "https://github.com/scaleway/scaleway-cli/releases/download/v2.2.2/scw-2.2.2-linux-x86_64"
...
You can download the last release here: https://github.com/scaleway/scaleway-cli/releases/download/v2.2.2/scw-2.2.2-windows-x86_64.exe<br/>
...
wget "https://github.com/scaleway/scaleway-cli/releases/download/v2.2.2/scw-v2.2.2-${ARCH}.deb" -O /tmp/scw.deb
```
...
```sh
docker run -i --rm scaleway/cli:v2.2.2
```

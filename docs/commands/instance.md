...
Update image name
```
scw instance image update image-id=173814d5-7fbb-463c-8650-ec511c7f28e5 name=foo
```

Update image public
```
scw instance image update image-id=173814d5-7fbb-463c-8650-ec511c7f28e5 public=true
```

Add extra volume
```
scw instance image update image-id=173814d5-7fbb-463c-8650-ec511c7f28e5 extra-volumes.1.id=
```

...
| region | Default: `fr-par`, One of: `fr-par`, `it-mil`, `all` | Region to target. If none is passed will use default region from the config |
...
| region | Default: `fr-par`, One of: `fr-par`, `it-mil` | Region to target. If none is passed will use default region from the config |

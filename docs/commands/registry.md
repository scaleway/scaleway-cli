...
- [An image represents a container image]("#An image represents a container image")
  - [Delete an image]("#image-delete")
  - [Get a image]("#image-get")
  - [List all your images]("#image-list")
  - [Update an existing image]("#image-update")
...
- [A namespace is for images what a folder is for files]("#A namespace is for images what a folder is for files")
  - [Create a new namespace]("#namespace-create")
  - [Delete an existing namespace]("#namespace-delete")
  - [Get a namespace]("#namespace-get")
  - [List all your namespaces]("#namespace-list")
  - [Update an existing namespace]("#namespace-update")
- [A tag represents a container tag of an image]("#A tag represents a container tag of an image")
  - [Delete a tag]("#tag-delete")
  - [Get a tag]("#tag-get")
  - [List all your tags]("#tag-list")

...
| ~~owner-contact.extension-it.european-citizenship~~ | This option is useless anymore | Deprecated  |
| ~~owner-contact.extension-it.tax-code~~ | Tax_code is renamed to pin | Deprecated  |
...
| ~~administrative-contact.extension-it.european-citizenship~~ | This option is useless anymore | Deprecated  |
| ~~administrative-contact.extension-it.tax-code~~ | Tax_code is renamed to pin | Deprecated  |
...
| ~~technical-contact.extension-it.european-citizenship~~ | This option is useless anymore | Deprecated  |
| ~~technical-contact.extension-it.tax-code~~ | Tax_code is renamed to pin | Deprecated  |
...
| ~~extension-it.european-citizenship~~ | This option is useless anymore | Deprecated  |
| ~~extension-it.tax-code~~ | Tax_code is renamed to pin | Deprecated  |
...
| Name | Description | Argument Specifications |
|------|-------------|-------------------------|
| domains.{index} | A list of domain to search, TLD is optional | Required  |
...
| ~~new-owner-contact.extension-it.european-citizenship~~ | This option is useless anymore | Deprecated  |
| ~~new-owner-contact.extension-it.tax-code~~ | Tax_code is renamed to pin | Deprecated  |

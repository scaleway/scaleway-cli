...
| Name |   | Description |
|------|---|-------------|
| name | Required, Default: `<generated>` | Device name |
...
| Name |   | Description |
|------|---|-------------|
| name | Required, Default: `<generated>` | Hub name (up to 255 characters) |
| project-id |  | Project ID to use. If none is passed the default project ID will be used |
| product-plan | Required, Default: `plan_shared`, One of: `plan_unknown`, `plan_shared`, `plan_dedicated`, `plan_ha` | Hub product plan |
...
| Name |   | Description |
|------|---|-------------|
| name | Required, Default: `<generated>` | Network name |
| type | Required, One of: `unknown`, `sigfox`, `rest` | Type of network to connect with |

...
| forward-port-algorithm | Required<br />Default: `roundrobin`<br />One of: `roundrobin`, `leastconn` | Load balancing algorithm |
...
| forward-port |  |  |
| forward-port-algorithm | One of: `roundrobin`, `leastconn` |  |

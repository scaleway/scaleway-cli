...
| scaling-policy-spec.fixed-size.size                                  |                                                                          | Required                                                            |
| scaling-policy-spec.cpu-target.target-avg-percent                    |                                                                          | Required                                                            |
| scaling-policy-spec.memory-target.target-avg-percent                 |                                                                          | Required                                                            |

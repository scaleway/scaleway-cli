...
| privacy | Default: `public`, One of: `unknown_privacy`, `public`, `private` | Privacy policy of the container. |
| description |  | Container description. |
| image | Required | Image reference (e.g. "rg.fr-par.scw.cloud/my-registry-namespace/image:tag"). |
| protocol | Default: `http1`, One of: `unknown_protocol`, `http1`, `h2c` | Protocol the container uses. |
...
| sandbox | Default: `v2`, One of: `unknown_sandbox`, `v1`, `v2` | Execution environment of the container. |
...
| region | Default: `fr-par`, One of: `fr-par`, `nl-ams`, `pl-waw` | Region to target. If none is passed will use default region from the config |
...
| name |  |  |
| organization-id |  |  |
| region | Default: `fr-par`, One of: `fr-par`, `nl-ams`, `pl-waw`, `all` | Region to target. If none is passed will use default region from the config |

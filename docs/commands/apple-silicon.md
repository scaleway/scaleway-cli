...
| zone | Default: `fr-par-1`, One of: `fr-par-3` | Zone to target. If none is passed will use default zone from the config |
...
| zone | Default: `fr-par-1`, One of: `fr-par-3`, `all` | Zone to target. If none is passed will use default zone from the config |
...
| zone | Default: `fr-par-1`, One of: `fr-par-1`, `fr-par-3` | Zone to target. If none is passed will use default zone from the config |
...
| zone | Default: `fr-par-1`, One of: `fr-par-1`, `fr-par-3`, `all` | Zone to target. If none is passed will use default zone from the config |

...
- [A cluster is a Kubernetes Kapsule cluster]("#A cluster is a Kubernetes Kapsule cluster")
  - [Create a new cluster]("#cluster-create")
  - [Delete a cluster]("#cluster-delete")
  - [Get a cluster]("#cluster-get")
  - [List all the clusters]("#cluster-list")
  - [List available versions for a cluster]("#cluster-list-available-versions")
  - [Reset the admin token of a cluster]("#cluster-reset-admin-token")
...
- [A node is the representation of a Scaleway instance in a cluster]("#A node is the representation of a Scaleway instance in a cluster")
...
- [A pool is a virtual group of nodes in a cluster]("#A pool is a virtual group of nodes in a cluster")
  - [Create a new pool in a cluster]("#pool-create")
  - [Delete a pool in a cluster]("#pool-delete")
  - [Get a pool in a cluster]("#pool-get")
  - [List all the pools in a cluster]("#pool-list")
...
- [A version is a Kubernetes version]("#A version is a Kubernetes version")
  - [Get details about a specific version]("#version-get")
  - [List all available versions]("#version-list")

  
## A cluster is a Kubernetes Kapsule cluster
...
## A node is the representation of a Scaleway instance in a cluster
...
## A pool is a virtual group of nodes in a cluster
...
## A version is a Kubernetes version

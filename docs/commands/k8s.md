...
| cni                                                | Container Network Interface (CNI) plugin running in the cluster                                                                                                                                                                                                                                                                                                                                       | Required<br />Default: `cilium`<br />One of: `unknown_cni`, `cilium`, `calico`, `weave`, `flannel`, `kilo`, `none`, `cilium_native` |

...
- [IPv6 block commands](#ipv6-block-commands)
  ...
  - [Get first IPv6 block](#get-first-ipv6-block)
...
```shell
scw dedibox server list-options <server-id ...> [arg=value ...]
```
...
```shell
scw dedibox server subscribe-option <server-id ...> [arg=value ...]
```
...
```shell
scw dedibox server subscribe-storage <server-id ...> [arg=value ...]
```

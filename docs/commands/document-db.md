...
# Documentation for `scw document-db`
...
- [Endpoint management](#endpoint-management)
  ...
  - [Migrate Database Instance endpoint](#migrate-database-instance-endpoint)
...
- [Instance management commands](#instance-management-commands)
  ...
  - [Update a Database Instance](#update-a-database-instance)

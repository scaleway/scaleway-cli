...
")
  - [Add an ACL instance to a given instance]("#acl-add")
  - [Delete ACL rules of a given instance]("#acl-delete")
  - [List ACL rules of a given instance]("#acl-list")
- [Backups are extracted data of your database at a given time
]("#Backups are extracted data of your database at a given time
")
  - [Create a database backup]("#backup-create")
  - [Delete a database backup]("#backup-delete")
  - [Export a database backup]("#backup-export")
  - [Get a database backup]("#backup-get")
  - [List database backups]("#backup-list")
  - [Restore a database backup]("#backup-restore")
  - [Update a database backup]("#backup-update")
- [TLS certificate used by your instance]("#TLS certificate used by your instance")
  - [Get the TLS certificate of an instance]("#certificate-get")
- [Manage logical databases on your instance
]("#Manage logical databases on your instance
")
  - [Create a database in a given instance]("#database-create")
  - [Delete a database in a given instance]("#database-delete")
  - [List all database in a given instance]("#database-list")
- [Software that stores and retrieves data from a database
]("#Software that stores and retrieves data from a database
")
  - [List available database engines]("#engine-list")
- [A Database Instance is composed of one or more Nodes, depending of the is_ha_cluster setting
]("#A Database Instance is composed of one or more Nodes, depending of the is_ha_cluster setting
")
  - [Clone an instance]("#instance-clone")
  - [Create an instance]("#instance-create")
  - [Delete an instance]("#instance-delete")
  - [Get an instance]("#instance-get")
  - [List instances]("#instance-list")
  - [Get instance metrics]("#instance-metrics")
  - [Update an instance]("#instance-update")
  - [Upgrade an instance to an higher instance type]("#instance-upgrade")
  - [Wait for an instance to reach a stable state]("#instance-wait")
- [Logs generated by your instance]("#Logs generated by your instance")
  - [List available logs of a given instance]("#log-list")
  - [Prepare logs of a given instance]("#log-prepare")
- [Node types powering your instance
]("#Node types powering your instance
")
  - [List available node types]("#node-type-list")
- [Define some privileges to a user on a specific database
]("#Define some privileges to a user on a specific database
")
  - [List privileges of a given user in a given database in a given instance]("#privilege-list")
  - [Set privileges of a given user in a given database in a given instance]("#privilege-set")
- [Instance Settings are tunables of Database Engines
]("#Instance Settings are tunables of Database Engines
")
  - [Add an instance setting]("#settings-add")
  - [Delete an instance setting]("#settings-delete")
- [Manage users on your instance
]("#Manage users on your instance
")
  - [Create an user in a given instance]("#user-create")
  - [Delete an user in a given instance]("#user-delete")
  - [List users of a given instance]("#user-list")
  - [Update an user in a given instance]("#user-update")

...
func init() {
	...
	cmdCreate.Flag.StringVar(&createCommercialType, []string{"-commercial-type"}, "X64-2GB", "Create a server with specific commercial-type C1, X64-[2|4|8|15|30|60|120]GB, C2[S|M|L]")

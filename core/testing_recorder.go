...
func cassetteRequestFilter(i *cassette.Interaction) error {
	...
	i.URL = orgIDRegex.ReplaceAllString(i.URL, "organization_id=11111111-1111-1111-1111-111111111111")
	i.URL = tokenRegex.ReplaceAllString(i.URL, "api.scaleway.com/account/v1/tokens/11111111-1111-1111-1111-111111111111")
	i.URL = apiKeyRegex.ReplaceAllString(i.URL, "api.scaleway.com/iam/v1alpha1/api-keys/SCWXXXXXXXXXXXXXXXXX")

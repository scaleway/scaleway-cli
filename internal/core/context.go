...
// NewClientContextWithOpts return a minimal context with auth options
func NewClientContextWithOpts(ctx context.Context, opts ...scw.ClientOption) context.Context {

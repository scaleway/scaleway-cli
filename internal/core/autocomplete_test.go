...
func TestAutocomplete(t *testing.T) {
	...
	t.Run("scw test flower -o ", run(&testCase{Suggestions: AutocompleteSuggestions{"human", "json", "template", "yaml"}}))
	...
	t.Run("scw test flower delete -o ", run(&testCase{Suggestions: AutocompleteSuggestions{"human", "json", "template", "yaml"}}))

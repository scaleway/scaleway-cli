...
func Test_ServerTerminate(t *testing.T) {
	...
	t.Run("without IP", core.Test(&core.TestConfig{
		Commands:   GetCommands(),
		BeforeFunc: core.ExecStoreBeforeCmd("Server", testServerCommand("image=ubuntu-bionic -w")),
	...
	t.Run("without block", core.Test(&core.TestConfig{
		Commands:   GetCommands(),
		BeforeFunc: core.ExecStoreBeforeCmd("Server", testServerCommand("image=ubuntu-bionic additional-volumes.0=block:10G -w")),
...
func Test_ServerBackup(t *testing.T) {
	t.Run("simple", core.Test(&core.TestConfig{
		Commands:   GetCommands(),
		BeforeFunc: core.ExecStoreBeforeCmd("Server", testServerCommand("stopped=true image=ubuntu-bionic")),

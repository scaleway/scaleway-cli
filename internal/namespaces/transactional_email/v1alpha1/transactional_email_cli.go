...
func temEmailCreate() *core.Command {
	return &core.Command{
		...
		Verb:      "create",
		// Deprecated:    false,
		ArgsType: reflect.TypeOf(transactional_email.CreateEmailRequest{}),
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*transactional_email.CreateEmailRequest)

			client := core.ExtractClient(ctx)
			api := transactional_email.NewAPI(client)
...
func temEmailGet() *core.Command {
	return &core.Command{
		...
		Verb:      "get",
		// Deprecated:    false,
		ArgsType: reflect.TypeOf(transactional_email.GetEmailRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "email-id",
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*transactional_email.GetEmailRequest)
...
func temEmailList() *core.Command {
	return &core.Command{
		...
		Verb:      "list",
		// Deprecated:    false,
		ArgsType: reflect.TypeOf(transactional_email.ListEmailsRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "project-id",
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*transactional_email.ListEmailsRequest)
...
func temEmailGetStatistics() *core.Command {
	return &core.Command{
		...
		Verb:      "get-statistics",
		// Deprecated:    false,
		ArgsType: reflect.TypeOf(transactional_email.GetStatisticsRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "project-id",
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*transactional_email.GetStatisticsRequest)
...
func temEmailCancel() *core.Command {
	return &core.Command{
		...
		Verb:      "cancel",
		// Deprecated:    false,
		ArgsType: reflect.TypeOf(transactional_email.CancelEmailRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "email-id",
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*transactional_email.CancelEmailRequest)
...
func temDomainCreate() *core.Command {
	return &core.Command{
		...
		Verb:      "create",
		// Deprecated:    false,
		ArgsType: reflect.TypeOf(transactional_email.CreateDomainRequest{}),
		ArgSpecs: core.ArgSpecs{
			core.ProjectIDArgSpec(),
			{
				Name:       "domain-name",
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*transactional_email.CreateDomainRequest)
...
func temDomainGet() *core.Command {
	return &core.Command{
		...
		Verb:      "get",
		// Deprecated:    false,
		ArgsType: reflect.TypeOf(transactional_email.GetDomainRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "domain-id",
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*transactional_email.GetDomainRequest)
...
func temDomainList() *core.Command {
	return &core.Command{
		...
		Verb:      "list",
		// Deprecated:    false,
		ArgsType: reflect.TypeOf(transactional_email.ListDomainsRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "project-id",
				Required:   false,
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*transactional_email.ListDomainsRequest)
...
func temDomainRevoke() *core.Command {
	return &core.Command{
		...
		Verb:      "revoke",
		// Deprecated:    false,
		ArgsType: reflect.TypeOf(transactional_email.RevokeDomainRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "domain-id",
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*transactional_email.RevokeDomainRequest)
...
func temDomainCheck() *core.Command {
	return &core.Command{
		...
		Verb:      "check",
		// Deprecated:    false,
		ArgsType: reflect.TypeOf(transactional_email.CheckDomainRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "domain-id",
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*transactional_email.CheckDomainRequest)

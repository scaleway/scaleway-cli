...
func dediboxInvoice() *core.Command {
	return &core.Command{
		Short:     `Invoice commands`,
		Long:      `Invoice commands.`,
		Namespace: "dedibox",
		Resource:  "invoice",
	}
}

func dediboxRefund() *core.Command {
	return &core.Command{
		Short:     `Refund commands`,
		Long:      `Refund commands.`,
		Namespace: "dedibox",
		Resource:  "refund",
	}
}

func dediboxAccountInfo() *core.Command {
	return &core.Command{
		Short:     `Account possibility of ordering commands`,
		Long:      `Account possibility of ordering commands.`,
		Namespace: "dedibox",

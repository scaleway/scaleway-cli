...
func lbSubscriberCreate() *core.Command {
	return &core.Command{
		Short:     `Create a subscriber, webhook or email`,
		Long:      `Create a subscriber, webhook or email.`,
		Namespace: "lb",
		Resource:  "subscriber",
		Verb:      "create",
		ArgsType:  reflect.TypeOf(lb.CreateSubscriberRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "name",
			...
			},
			{
				...
				Short:      `Email who receive alert`,
				Required:   true,
				Positional: false,
			},
			{
				Name:       "webhook-config.uri",
				Short:      `URI who receive POST request`,
				Required:   true,
				Positional: false,
			},
			core.OrganizationIDArgSpec(),
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*lb.CreateSubscriberRequest)
...
func lbSubscriberGet() *core.Command {
	return &core.Command{
		...
		Long:      `Get a subscriber.`,
		Namespace: "lb",
		Resource:  "subscriber",
		Verb:      "get",
		ArgsType:  reflect.TypeOf(lb.GetSubscriberRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "subscriber-id",
				Short:      `Subscriber ID`,
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*lb.GetSubscriberRequest)
...
func lbSubscriberList() *core.Command {
	return &core.Command{
		Short:     `List all subscriber`,
		Long:      `List all subscriber.`,
		Namespace: "lb",
		Resource:  "subscriber",
		Verb:      "list",
		ArgsType:  reflect.TypeOf(lb.ListSubscriberRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "order-by",
				Short:      `You can order the response by created_at asc/desc or name asc/desc`,
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*lb.ListSubscriberRequest)

			client := core.ExtractClient(ctx)
			api := lb.NewAPI(client)
			resp, err := api.ListSubscriber(request, scw.WithAllPages())
			if err != nil {
				return nil, err
			}
...
func lbSubscriberUpdate() *core.Command {
	return &core.Command{
		...
		Long:      `Update a subscriber.`,
		Namespace: "lb",
		Resource:  "subscriber",
		Verb:      "update",
		ArgsType:  reflect.TypeOf(lb.UpdateSubscriberRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "subscriber-id",
				Short:      `Subscriber ID`,
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*lb.UpdateSubscriberRequest)
...
func lbSubscriberDelete() *core.Command {
	return &core.Command{
		...
		Resource:  "subscriber",
		Verb:      "delete",
		ArgsType:  reflect.TypeOf(lb.DeleteSubscriberRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "subscriber-id",
				Short:      `Subscriber ID`,
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*lb.DeleteSubscriberRequest)
...
func lbSubscriberSubscribe() *core.Command {
	return &core.Command{
		Short:     `Subscribe a subscriber to a given load balancer`,
		Long:      `Subscribe a subscriber to a given load balancer.`,
		Namespace: "lb",
		Resource:  "subscriber",
		Verb:      "subscribe",
		ArgsType:  reflect.TypeOf(lb.SubscribeToLbRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "lb-id",
				Short:      `Load balancer ID`,
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*lb.SubscribeToLbRequest)
...
func lbSubscriberUnsubscribe() *core.Command {
	return &core.Command{
		Short:     `Unsubscribe a subscriber from a given load balancer`,
		Long:      `Unsubscribe a subscriber from a given load balancer.`,
		Namespace: "lb",
		Resource:  "subscriber",
		Verb:      "unsubscribe",
		ArgsType:  reflect.TypeOf(lb.UnsubscribeFromLbRequest{}),
		ArgSpecs: core.ArgSpecs{
			{
				Name:       "lb-id",
				Short:      `Load balancer ID`,
		...
		Run: func(ctx context.Context, args interface{}) (i interface{}, e error) {
			request := args.(*lb.UnsubscribeFromLbRequest)

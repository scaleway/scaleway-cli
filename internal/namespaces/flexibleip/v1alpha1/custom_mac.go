...
var (
	macAddressStatusMarshalSpecs = human.EnumMarshalSpecs{
		...
		flexibleip.MACAddressStatusReady:    &human.EnumMarshalSpec{Attribute: color.FgGreen},
		flexibleip.MACAddressStatusUpdating: &human.EnumMarshalSpec{Attribute: color.FgBlue},
		// flexibleip.MACAddressStatusUsed:     &human.EnumMarshalSpec{Attribute: color.Faint},
